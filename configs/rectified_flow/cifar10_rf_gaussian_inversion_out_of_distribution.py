...
def get_config():
  ...
  reflow.reflow_type = 'inversion_out_of_distribution' # NOTE: generate_data_from_z0, train_reflow
  ...
  data.image_size = 32 # should be 256
  data.random_flip = True
  data.uniform_dequantization = False
  data.centered = False
  data.num_channels = 3
  data.root_path = 'lsun_church_outdoor'
